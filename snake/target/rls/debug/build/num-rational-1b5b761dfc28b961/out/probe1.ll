...
@alloc28 = private unnamed_addr constant <{ [101 x i8] }> <{ [101 x i8] c"/Users/volchan/.rustup/toolchains/stable-x86_64-apple-darwin/lib/rustlib/src/rust/src/liballoc/vec.rs" }>, align 1
@alloc29 = private unnamed_addr constant <{ i8*, [16 x i8] }> <{ i8* getelementptr inbounds (<{ [101 x i8] }>, <{ [101 x i8] }>* @alloc28, i32 0, i32 0, i32 0), [16 x i8] c"e\00\00\00\00\00\00\00N\09\00\00%\00\00\00" }>, align 8
